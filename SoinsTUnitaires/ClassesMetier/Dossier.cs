...
namespace ClassesMetier
{
    ...
    public class Dossier
    {
        ...
        public int GetNbJoursSoins()
        {
            ...
            foreach (Prestation unePrestation in this.MesPrestations)
            {
                if (!lesDates.Contains(unePrestation.GetsDateHeureSoin.Date))
                {
                    lesDates.Add(unePrestation.GetsDateHeureSoin.Date);
                }
            }
        ...
        public int GetNbJoursSoinsV2()
        {
            ...
            else
            {
                ...
                {
                    return prestation1.GetsDateHeureSoin.Date.CompareTo(prestation2.GetsDateHeureSoin.Date);
                });
        ...
        public int GetNbJoursSoinsV3()
        {
            ...
            return this.MesPrestations.Select(x => x.GetsDateHeureSoin.Date).Distinct().Count();
        }
